function[spanning_trees_impedance_matrix_opt_two] = spanning_trees_impedance_matrix_opt_two_computation (span_trees_root_impedance_matrix, PMU_nodes, n_spanning_trees, n_lines, idx_line, idx_from)
